...
export default function Ajuda() {
    return (
        <div className="container flex items-center justify-center min-h-screen lg:px-40 py-30 max-sm:px-0 max-sm:py-6 md:py-20 md:px-2">
            <div className="grid grid-cols-2 gap-8 p-8 max-sm:flex max-sm:flex-col max-sm:items-center max-sm:py-2 max-sm:px-0">
                <div className="flex flex-col justify-start max-sm:items-center max-sm:text-center max-sm:w-5/6">
                    ...
                    <p className="text-start mb-4 lg:w-10/12 max-sm:text-sm max-sm:w-full md:w-3/4">Estamos prontos para ajudar você a resolver qualquer dúvida ou problema. Entre em contato conosco para
