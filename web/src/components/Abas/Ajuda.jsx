        ...
        <div className="container flex items-center justify-center min-h-screen px-40 py-30 max-sm:px-20 max-sm:py-6">
            <div className="grid grid-cols-2 gap-8 p-8 max-sm:flex max-sm:flex-col max-sm:items-center max-sm:py-2">
                <div className="flex flex-col justify-start max-sm:items-center max-sm:text-center max-sm:w-3/4">
                    ...
                    <p className="text-start mb-4 w-3/5 max-sm:text-sm max-sm:w-full">Estamos prontos para ajudar você a resolver qualquer dúvida ou problema. Entre em contato conosco para
