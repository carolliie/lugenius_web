...
export default function Funcionalidades() {
    return (
        <div className="flex flex-col items-center justify-between space-y-8">
            ...
            <div className="flex items-center justify-center w-3/5 space-x-36 space-y-20 mb-20">
                <div className="w-1/2">
                    <h2 className="text-start text-3xl font-bold mb-4">Diversas opções para receber pagamentos</h2>
                    <p className="text-start text-gray-600">
            ...
            <div className="flex items-center justify-center w-3/5 space-x-36 space-y-20 mb-20">
                ...
                <div className="w-1/2">
                    <h2 className="text-start text-3xl font-bold mb-4">Cálculo de envio automático</h2>
                    <p className="text-start text-gray-600">
            ...
            <div className="flex items-center justify-center w-3/5 space-x-36 space-y-20 mb-20">
                <div className="w-1/2">
                    <h2 className="text-start text-3xl font-bold mb-4">Relatório de vendas detalhados</h2>
                    <p className="text-start text-gray-600">
            ...
            <div className="flex items-center justify-center w-3/5 space-x-36 space-y-20 mb-20">
                ...
                <div className="w-1/2">
                    <h2 className="text-start text-3xl font-bold mb-4">Promoções e cupons de desconto</h2>
                    <p className="text-start text-gray-600">
            ...
            <div className="flex items-center justify-center w-3/5 space-x-36 space-y-20 mb-20">
                <div className="w-1/2">
                    <h2 className="text-start text-3xl font-bold mb-4">Gestão completa do seu E-commerce</h2>
                    <p className="text-start text-gray-600">
